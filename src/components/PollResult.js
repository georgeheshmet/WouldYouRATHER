      ...
      return (
          <div className='container rounded border p-3 m-2' >
              <div className='row justify-content-start'>
                 <h6 className='col'>Question asked by {this.props.user.name} :</h6>                 
            </div>
            <div className='row justify-content-start p-3'>
                 ...
                 <div className={this.props.useranswer==='optionOne'?'addBg border border-dark rounded p-3 m-3':null}>
                 
                    Would you rather {this.props.question.optionOne.text}?
                    <div>

                    <Progress percent={this.props.question.optionOne.votes.length*100/(this.props.question.optionOne.votes.length+this.props.question.optionTwo.votes.length)} indicating />
                    </div>
                 </div>
                 ...
                 <div className={this.props.useranswer==='optionTwo'?'addBg border border-dark rounded p-3':'border border-dark rounded p-3 m-3 '}>

                    Would you rather {this.props.question.optionTwo.text}?
                    <Progress percent={this.props.question.optionTwo.votes.length*100/(this.props.question.optionOne.votes.length+this.props.question.optionTwo.votes.length)} indicating />
                 </div>
                 </div>
            </div>
          </div>
